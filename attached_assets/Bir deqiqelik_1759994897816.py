...
CHAT_ID = ''
RSI_PERIOD = 14
KLN_LIMIT = 500  # yeterli veri ile TradingView ile eşleşme
MAX_WORKERS = 20
SLEEP_AFTER_BATCH = 1
MIN_INTERVAL = 300  # aynı coin tekrar mesaj süresi (5 dk)
# ========================================
...
def validate_tradingview_link(symbol: str) -> str:
    """TradingView linkini üretir. Eğer sembolde .P yoksa ekler, varsa tekrarlamaz."""
    if symbol in TV_LINK_CACHE:
        return TV_LINK_CACHE[symbol]
    
    # Eğer sembolde .P yoksa ekle
...
if __name__ == "__main__":
    print("Binance Futures RSI Bot (USDT-M) başlatılıyor...")
    main_loop()
